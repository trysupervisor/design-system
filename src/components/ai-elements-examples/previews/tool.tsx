...
| 5 | Charlie Davis | charlie@example.com | 2024-02-15 |`,
  ...
  toolCallId: "database-query-example",
  type: "tool-database_query" as const,
};

const Example = () => {
  const [decision, setDecision] = useState<Decision>("pending");
  const decisionState: ToolUIPart["state"] = decision === "pending" ? "approval-requested" : "approval-responded";
  const decisionApproval = decision === "pending"
    ? { id: "database-query-approval" }
    : { id: "database-query-approval", approved: decision === "approved" };
  ...
  return (
    ...
    <Tool>
      ...
      <ToolContent>
        ...
        <Confirmation approval={decisionApproval} state={decisionState}>
          <ConfirmationTitle>
            <ConfirmationRequest>
    ...
    <Tool>
      ...
      <ToolContent>
        <ToolInput input={toolCall.input} />
        <Confirmation
          approval={{ approved: true, id: "responded-example" }}
    ...
    <Tool>
      ...
      <ToolContent>
        <ToolInput input={toolCall.input} />
        <Confirmation
          approval={{ approved: true, id: "completed-example" }}
