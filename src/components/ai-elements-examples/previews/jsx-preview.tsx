...
const fullJsx = `<div className="rounded-lg border bg-card p-6 shadow-sm">
  <div className="flex items-center gap-4 mb-4">
    ...
    <div>
      <h2 className="text-lg font-semibold">Rendered sample</h2>
      <p className="text-sm text-muted-foreground">Fixed JSX source</p>
    </div>
  </div>
  <div className="space-y-3">
    <p className="text-sm">This sample renders from a fixed JSX string. Start the stream to see partial tags resolve as the source arrives.</p>
  ...
  <div className="mt-4 pt-4 border-t">
    <div className="flex justify-between items-center">
      <span className="text-xs text-muted-foreground">Fixed sample data</span>
