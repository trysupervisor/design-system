...
export function Combobox({ options, value, onValueChange, placeholder = "Choose an option", searchPlaceholder = "Search options", emptyMessage = "No option found.", className }: { options: ComboboxOption[]; value?: string; onValueChange?: (value: string) => void; placeholder?: string; searchPlaceholder?: string; emptyMessage?: string; className?: string }) {
