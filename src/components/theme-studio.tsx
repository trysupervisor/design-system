          ...
          <div className="rounded-2xl border bg-card shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-2 border-b p-4 sm:p-5">
              ...
              <div className="col-span-2 mt-1 rounded-lg bg-muted/50 p-2.5 text-[10px] leading-4 text-muted-foreground">
                ...
                {headingFontSetup.id !== fontSetup.id && <><code className="mt-2 block break-all">bun add {headingFontSetup.packageName}</code><code className="block break-all">{headingFontSetup.cssImport}</code></>}
                {draft.buttonFont === "mono" && <><code className="mt-2 block break-all">bun add @fontsource-variable/geist-mono</code><code className="block break-all">{'@import "@fontsource-variable/geist-mono";'}</code></>}
              </div>
            </div>
