...
Numeric units: radius, optional inputRadius, optional buttonRadius, and controlHeight are in rem; optional buttonWeight is an integer from 400 to 800; borderWidth, optional panelBorderWidth, and shadow blur/spread/x/y are pixels; spacing and textScale are unitless scales; shadow opacity is a fraction. Use panelBorderWidth 0 for filled cards without borders while preserving input borders. Optional headingFont uses the same allowed font identifiers as font. Optional buttonFont is body or mono. Default shape is radius 0.375, borderWidth 1, spacing 1, controlHeight 2.25, textScale 1, and no shadow.
